package io.hayk.rsocketdemo.note.note.api;
                ...
                CompletableFuture.supplyAsync(() ->
                        ...
                        .whenComplete((res, th) -> {
                            if (th != null) {
                                ...
                                logger.error("A new note with id - {} was successfully created.", res.noteId());
                            }
                        })
                ...
                updateNoteContent(request)
                        .whenComplete((res, th) -> {
                            if (th != null) {
                                ...
                                logger.error("A note with id - {} was successfully updated.", res.noteId());
                            }
                        })
                        .thenApply(NoteController::toGenericNoteResult)
        );
